...
camObject.set(cv2.CAP_PROP_EXPOSURE, 60) #exposure
camObject.set(cv2.CAP_PROP_ISO_SPEED, 200)  #ISO 
...
#ord function convert character to unicode value
    if userkey == ord('q'): #close the camera
        ...
        cv2.imwrite("D:\APU Stuff\Bachelor of Computer Science (Intelligent Systems) [APD2F2202CS(IS)]\Semester 2\Imaging & Special Effects [CT029-3-2-ISE]\Mine\Labs\Lab_3\image_%d.jpg" %imageNumber, img)
