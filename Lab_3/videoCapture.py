...
if videoCam.isOpened():
    ...
    video = cv2.VideoWriter("D:\APU Stuff\Bachelor of Computer Science (Intelligent Systems) [APD2F2202CS(IS)]\Semester 2\Imaging & Special Effects [CT029-3-2-ISE]\Mine\Labs\Lab_3\RecordedVideo.avi",codec,15.0,size)
